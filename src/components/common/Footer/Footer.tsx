            ...
            <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
              ...
              <div className="col-span-2 sm:col-span-1">
                ...
                <ul className="mt-6 space-y-4 text-sm">
                  ...
                  <li>
                    <p className=" text-xs font-thin text-slate-50 transition hover:opacity-75">
                  ...
                  <li>
                    <Input
                      ...
                      sx={{
                        backgroundColor: "black", // خلفية سوداء
                        border: "1px solid white", // بوردر أبيض
                        color: "white", // لون النص أبيض
                        width: "150px", // تغيير العرض
                        height: "20px", // تغيير الارتفاع
                        "&::before": {
                          display: "none",
                        },
                        "&:focus-within": {
                      ...
                      endDecorator={
                        <Button
                          variant="solid"
                          sx={{
                            backgroundColor: "white", // خلفية الزر بيضاء
                            color: "black", // لون النص أسود
                            "&:hover": {
                              backgroundColor: "white", // لون الخلفية عند التمرير
                            },
                          }}
                        >
                          <IoMdSend />
              ...
              <div className="col-span-2 sm:col-span-1">
                ...
                <ul className="mt-6 space-y-4 text-sm">
                  <li>
                    <p className=" text-[8px] font-thin text-slate-50 transition hover:opacity-75">
